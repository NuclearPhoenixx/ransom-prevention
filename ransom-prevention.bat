...
echo Visit https://github.com/phoenix1747/ransom-prevention/ for updates and fixes.
echo.
echo.
echo Thanks for your interest in this script!
echo.
echo.
echo.
...
cls
echo.
echo Done! All files have been installed successfully. You should now be safe.
echo.
echo Press any key to exit...
pause>NUL
exit
